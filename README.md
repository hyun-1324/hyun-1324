...
| ------------------------------------------------------------- | --------------------------------------------------------------------------- | ----------------------------------------------------------- |
| [Pawfect Match](https://github.com/hyun-1324/Pawfect_Match)   | Tinder for dogs – a real-time matchmaking app 🐶                            | Go, PostgreSQL, WebSocket, Docker, Nginx, React, TypeScript |
| [Speedy Serpent](https://github.com/hyun-1324/Speedy_Serpent) | Online multiplayer snake game with a singleplayer mode against AI opponents | Node.js, Socket.IO, React, TypeScript                       |
| [Philosophers](https://github.com/hyun-1324/philosophers)     | Dining Philosophers with thread-level optimization                          | C, pthreads, mutex, Linux                                   |
